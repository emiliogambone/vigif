...
export default DS.Serializer.extend({
  ...
  for(var i=0; i<nomi.length; i++){
    ...
    json.data.push({"id":code[i].childNodes[0].nodeValue, "type":"seriousness", attributes:{"name":nomi[i].childNodes[0].nodeValue, "aifa":code[i].childNodes[0].nodeValue}});
