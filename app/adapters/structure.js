...
const { Promise } = RSVP;
/**
  *Adapter delle strutture ospedaliere
  *
  *Adapter che recupera dal server i valori delle strutture ospedaliere(structure)
  *@augments DS/Adapter
  */
export default DS.Adapter.extend({

  defaultSerializer: 'structure',
  ...
  */
  findAll(){
    ...
    return new Promise(function(resolve,reject){
      ...
      var method = 'GET';
      var url = url_read + "healthcare_structures";
